...
show_metric(cols[2], "Nikkei 225", "^N225", "Japan. Leads Asian session. Sensitive to USD/JPY and global risk.")
show_metric(cols[3], "EuroStoxx 50", "^STOXX50E", "Europe benchmark. Sensitive to EUR, ECB policy, energy prices.")
