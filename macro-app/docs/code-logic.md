...
| 2026-06-12 | Early roll strategy implemented — commodity contracts switch to next month ~1 week before expiry (roll_day=13 for WTI, 18 for metals) instead of at expiry. Avoids thin liquidity window in final days of front-month contract. Prioritises clean delta signal over matching Finviz exactly during roll week. Industry desk rule: never use front-month signals near expiry. Small basis difference accepted as tradeoff. |
